...
import { formatCurrency, formatDate, formatDateDDMMYYYY } from '@/utils/format';
import {
  buildCourtReport,
...
export default function ReportsScreen() {
  ...
  const [aliReportClients, setAliReportClients] = useState<Client[]>([]);
          ...
          <>
              ...
              <View style={styles.assistantBox}>
                <View style={styles.assistantTextWrap}>
                  ...
                  <Text style={styles.assistantSubtitle}>
                    التقرير يرتب العملاء حسب درجة الأولوية، ويصدر PDF وXLSX متوافق مع Excel متضمنًا المبلغ، التاريخ، آخر متابعة، والإجراء المقترح.
                  </Text>
                </View>
            ...
            <AppCard title="مركز التقارير">
              <View style={styles.summaryGrid}>
                ...
                <View style={styles.summaryBox}>
                  <Text style={styles.summaryValue}>PDF / XLSX</Text>
                  <Text style={styles.summaryLabel}>صيغ التصدير</Text>
                </View>
              </View>
              <Text style={styles.helperText}>
                يتم إنشاء ملفات PDF مباشرة من التطبيق، وملفات XLSX عربية متوافقة مع Excel للمشاركة أو الحفظ.
              </Text>
            </AppCard>
